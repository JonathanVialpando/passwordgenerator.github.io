...
def generatePassword(strength):
    ...
    if strength == 1:
        ...
        passwordList += string.digits + string.ascii_uppercase + string.punctuation
...
def checkPassword(password):
    ...
    if len(password) < 8: 
        msg += "Try adding more characters <br><br>"

    if password.islower() :
        msg += "Try using capital characters <br><br>"

    if any(char.isdigit() for char in password) == 0:
        msg += "Try using a digit <br><br>"
